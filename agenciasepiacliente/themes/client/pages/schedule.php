                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex">
                                    <div class="avatar avatar-md">
                                        <img class="previewImage" src="<?= url($client["previewImage"]); ?>">
                                    </div>
                            ...
                            <div class="col-12 overflow-auto scrollOff" style="max-height: 27em;">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 mt-2 name">
                                        <h6 class="text-muted mb-0 clientUserLabel">@<?= $client["userClient"] ?></h6>
                                        <p id="copyInsta"></p>
                                    </div>
                                </div>
                            </div>
...
<script src="<?= url("themes/client/assets/js/schedule.js"); ?>"></script>
<?php $v->end(); ?>
